...
namespace linkedlist_quanly
{
    ...
    public class Post
    {
        ...
        public string SharedBy { get; set; } // Người share bài viết
        public Post OriginalPost { get; set; } // Bài viết gốc
    ...
    public class SocialMediaLinkedList
    {
        ...
        public List<Post> GetAllPosts()
        {
            ...
            while (current != null)
            {
                ...
                if (current.OriginalPost != null)
                {
                    posts.Add(current); // Thêm bài viết đã được share
                }
                else
                {
